        ...
        <div className="container mx-auto mt-10">
          <div className="flex shadow-md my-10">
            <div className="w-3/4 bg-white px-10 py-10">
                  ...
                  return (
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                      <div className="flex w-2/5">
                        <div className="w-20">
                          <img className="h-24" src={cart?.thumbnail} alt={cart?.title} />
                        </div>
              ...
              <Link to={'/products'} className="flex font-semibold text-blue-600 text-sm mt-10">
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              ...
              <div>
                ...
                <select className="block p-2 text-gray-600 w-full text-sm" onChange={handleShippingSelect}>
