...
const Header = () => {
    return (
      <header className="text-gray-600 body-font shadow-lg">
        ...
        <Link to={'/cart'} className="inline-flex items-center text-white bg-blue-500 border-0 py-2 px-4 focus:outline-none hover:bg-blue-700 rounded text-base mt-4 md:mt-0">Go to Cart
